...
export const getListStudent = createAsyncThunk(
  ...
  async () => {
    const students = await userApi.getListStudent();
    const newStudentArray = await students.data.map((student) => {
      const { id, avatar, name, sex, birth_place, birth_date, groups } =
        student;
...
export const getStudentDetail = createAsyncThunk(
  ...
  async (id) => {
    ...
    const newStudentArray = await student.data.map((student) => {
      const { id, avatar, email, name, sex, birth_place, birth_date, groups } =
        student;
...
export const destroyStudent = createAsyncThunk(
  "students/destroy",
  async (id) => {
...
export const filtersStudent = createAsyncThunk(
  "students/filters",
  async (params) => {
