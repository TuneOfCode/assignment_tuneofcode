...
import { countStudyGroup } from "../../features/groups/groupSlice";
import StudentTab from "../../features/students/components/StudentTab";
import { countStudentRegistered } from "../../features/students/studentSlice";
import "./tab.css";
const TabChildren = ({ tabName, description }) => {
  return (
    <Box>
      ...
      <Typography
        sx={{ fontSize: "15px", color: "#333", textTransform: "lowercase" }}
      >
        {description}
      </Typography>
    </Box>
